        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, 1, "Lauro", "Silva"),
                    new Professor(2, 2, "Roberto", "Queiroz"),
                    new Professor(3, 3, "Ronaldo", "Ferrari"),
                    new Professor(4, 4, "Rodrigo", "Cavalcante"),
                    new Professor(5, 5, "Alexandre", "Junior")
                });

            builder.Entity<Curso>()
                .HasData(new List<Curso>{
                    new Curso(1,"Engenharia da Computação"),
                    new Curso(2,"Sistemas de Informção"),
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.Parse("28/05/2022")),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", DateTime.Parse("28/05/2022")),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", DateTime.Parse("28/05/2022")),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", DateTime.Parse("28/05/2022")),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", DateTime.Parse("28/05/2022")),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", DateTime.Parse("28/05/2022")),
                    new Aluno(7, 7, "Paulo", "José", "9874512", DateTime.Parse("28/05/2022"))
                });
